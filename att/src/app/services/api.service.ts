...
export class ApiService {
  ...
  getAttendanceBySinglePunch(adate)
  {
    const body = {
      'utype': localStorage.getItem('utype'),
      'adate': adate,
    };
    return this.callApi(AppSettings.GET_ATTENDANCE_BY_SINGLEPUNCH_API, 'post', body);
  }
  getAttendanceByNoPunch(adate)
  {
    const body = {
      'utype': localStorage.getItem('utype'),
      'adate': adate,
    };
    return this.callApi(AppSettings.GET_ATTENDANCE_BY_NOPUNCH_API, 'post', body);
  }
