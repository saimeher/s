...
<head>
    ...
    <link href="<?= base_url() ?>assets/global/css/components-md.css" rel="stylesheet" id="style_components"
          type="text/css"/>
    ...
    <link rel="stylesheet" type="text/css" href="<?=base_url()?>assets/customcss/style.css">
    <link rel="stylesheet" type="text/css" href="<?=base_url()?>assets/customcss/custom_tooltips.css">
    <link rel="stylesheet" type="text/css" href="<?=base_url()?>assets/customcss/select2.css">
...
<div class="page-header navbar navbar-fixed-top">
    ...
    <div class="page-header-inner ">
        <!-- BEGIN LOGO -->
        <div class="page-logo">
            <a href="<?=base_url().'admin/'?>" class="text_logo">
                <img src="<?= base_url() ?>assets/images/logo_ad.png" alt="logo" class="logo-default" width="130" height="50"/></a>
            ...
            <ul class="page-sidebar-menu  page-header-fixed page-sidebar-menu-hover-submenu " data-keep-expanded="false"
                ...
                <li class="nav-item   <?php if ($page == 'metertype') { ?> active <?php } ?>">
                    <a href="<?= base_url() . 'admin/metertype' ?>" class="nav-link nav-toggle">
                        ...
                        <span class="title">Meter Types</span>
                ...
                <li class="nav-item   <?php if ($page == 'cost') { ?> active <?php } ?>">
                    <a href="<?= base_url() . 'admin/cost_management' ?>" class="nav-link nav-toggle">
                        <i class="fa fa-inr"></i>
                        <span class="title">Cost Management</span>
                        <?php if ($page == 'cost') { ?>
                            <span class="selected"></span>
                            <span class="arrow open"></span> <?php } ?>
                    </a>
